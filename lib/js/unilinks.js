...
pathprefix = 'https://cdn.jsdelivr.net/gh/unilinksproject/data@';
filepath = "/"
...
function createTabs(list){
  ...
  ga.setAttribute('href', 'https://github.com/unilinksproject/unilinks');
...
function getTag(){
  var data = getFile('https://api.github.com/repos/unilinksproject/data/tags');
